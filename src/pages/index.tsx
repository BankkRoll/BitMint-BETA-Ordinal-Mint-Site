    ...
    return (
        <div>
            <Head>
                ...
                <meta name="keywords" content="bitcoin, ordinals, unisat, xverse, inscribed, minting, boilerplate"/>
                ...
                <meta property="og:image" content={constants.collectionImage} />
                {/* Twitter */}
                ...
                <meta property="twitter:image" content={constants.collectionImage} />
                {/* PWA primary color */}
